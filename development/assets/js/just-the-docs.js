...
function initSearch() {
  ...
  request.open('GET', '/hf-ads7952/development/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/hf-ads7952/development/assets/css/just-the-docs-' + theme + '.css');
}
